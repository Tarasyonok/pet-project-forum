...
**Night Coder** — это полнофункциональная платформа для сообщества разработчиков, созданная для тех волшебных часов, когда можно заняться своими идеями. Это место, где студенты и увлечённые разработчики собираются вместе, чтобы задавать вопросы, делиться знаниями и прокачивать навыки.
...
- **SQLite** - База данных для разработки и продакшена
...
7. **Запусти сервер для разработки**
   ```bash
